...
class alreadySendTVC: UITableViewController{
    
    var arrayOfCellData = [xianzhiSendData]()
        ...
        postRef.observe(.value, with:{
            ...
            for child in snapshot.children{
                    ...
                    let imageThreeUrl = dict["imageThreeUrl"] as? String
                {
                    ...
                    let post = xianzhiSendData(id: childSnapshot.key, name: name, price: price, extraInfo: extraInfo, timestamp: timestamp, imageOneUrl: imageOneUrl, imageTwoUrl: imageTwoUrl, imageThreeUrl: imageThreeUrl, author: userProfile)
