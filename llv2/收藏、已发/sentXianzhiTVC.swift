...
class sentXianzhiTVC: UITableViewController{
    
    var arrayOfCellData = [xianzhiData2]()
        ...
        postRef.observe(.value, with:{
            ...
            for child in snapshot.children{
                    ...
                    let imageThreeUrl = dict["imageThreeUrl"] as? String
                {
                    ...
                    let post = xianzhiData2(id: childSnapshot.key, name: name, price: price, extraInfo: extraInfo, timestamp: timestamp, imageOneUrl: imageOneUrl, imageTwoUrl: imageTwoUrl, imageThreeUrl: imageThreeUrl, author: userProfile)
